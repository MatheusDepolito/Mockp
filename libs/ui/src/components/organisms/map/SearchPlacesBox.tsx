import { LocationInfo, ViewState } from '@mockp/util/types';
import { useMap } from 'react-map-gl';
import { Autocomplete } from '../../atoms/AutoComplete';
import { useSearchLocation } from '@mockp/util/hooks/location';
import { majorCitiesLocationInfo } from '@mockp/util/constants';
